...
from functions import (
    ...
    initialize_conv_recommendation,
...
openai.api_key=open("shopAssit_2\OpenAI_API_Key.txt",'r').read().strip()
...
def default_func():
    ...
    return render_template("shop_assist_conversation_bot.html", name_xyz = conversation_bot)
...
def start_conversation():
    ...
    if moderation == 'Flagged':
        return redirect(url_for('end_conversation'))
    ...
    if top_3_laptops is None:
        ...
        if "No" in confirmation:
            ...
            conversation_reco = initialize_conv_recommendation(validated_reco)
